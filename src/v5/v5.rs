...
pub(crate) mod connack {
    ...
    impl ConnAck {
        pub fn new(code: ConnectReturnCode, session_present: bool) -> ConnAck {
            ConnAck { code, session_present, properties: None }
        }
...
pub(crate) mod puback {
    ...
    impl PubAckProperties {
        ...
        pub fn extract(mut bytes: &mut Bytes) -> Result<Option<PubAckProperties>, Error> {
            ...
            Ok(Some(PubAckProperties { reason_string, user_properties }))
        }
...
pub(crate) mod subscribe {
    ...
    impl Subscribe {
        pub fn new<S: Into<String>>(path: S, qos: QoS) -> Subscribe {
            ...
            filters.push(filter);
            Subscribe { pkid: 0, filters, properties: None }
        }
        ...
        pub fn read(fixed_header: FixedHeader, mut bytes: Bytes) -> Result<Self, Error> {
            ...
            let subscribe = Subscribe { pkid, filters, properties };
    ...
    impl SubscribeProperties {
        ...
        pub fn extract(
            ...
            Ok(Some(SubscribeProperties { id, user_properties }))
        }
